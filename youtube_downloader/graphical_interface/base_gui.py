...
class BaseGui(Frame):
    ...
    def __init__(self, parent_frame, controller):
        ...
        self._canvas = Canvas(master=self._frame, width=self.BASE_GUI_WIDTH, height=self.BASE_GUI_HEIGHT)
    ...
    def create_label(self, label_title, background_color = 'orange', text_color = 'black'):
        return Label(self, text=label_title, font=self.FONT, background=background_color, fg = text_color)
    ...
    def create_button_lambda(self, gui_class):
